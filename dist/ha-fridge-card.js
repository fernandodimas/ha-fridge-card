...
\f\r"'\`<>=]|("|')|))|$)`,"g"),kt=/'/g,Mt=/"/g,Ft=/^(?:script|style|textarea|title)$/i,at=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),$=at(1),ye=at(2),xe=at(3),b=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Pt=new WeakMap,v=C.createTreeWalker(C,129);function Bt(i,t){if(!nt(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Et!==void 0?Et.createHTML(t):t}var se=(i,t)=>{let e=i.length-1,r=[],s,o=t===2?"<svg>":t===3?"<math>":"",n=F;for(let h=0;h<e;h++){let a=i[h],c,d,l=-1,f=0;for(;f<a.length&&(n.lastIndex=f,d=n.exec(a),d!==null);)f=n.lastIndex,n===F?d[1]==="!--"?n=St:d[1]!==void 0?n=Dt:d[2]!==void 0?(Ft.test(d[2])&&(s=RegExp("</"+d[2],"g")),n=A):d[3]!==void 0&&(n=A):n===A?d[0]===">"?(n=s??F,l=-1):d[1]===void 0?l=-2:(l=n.lastIndex-d[2].length,c=d[1],n=d[3]===void 0?A:d[3]==='"'?Mt:kt):n===Mt||n===kt?n=A:n===St||n===Dt?n=F:(n=A,s=void 0);let p=n===A&&i[h+1].startsWith("/>")?" ":"";o+=n===F?a+ee:l>=0?(r.push(c),a.slice(0,l)+Tt+a.slice(l)+_+p):a+_+(l===-2?h:p)}return[Bt(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},U=class i{constructor({strings:t,_$litType$:e},r){let s;this.parts=[];let o=0,n=0,h=t.length-1,a=this.parts,[c,d]=se(t,e);if(this.el=i.createElement(c,r),v.currentNode=this.el.content,e===2||e===3){let l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(s=v.nextNode())!==null&&a.length<h;){if(s.nodeType===1){if(s.hasAttributes())for(let l of s.getAttributeNames())if(l.endsWith(Tt)){let f=d[n++],p=s.getAttribute(l).split(_),x=/([.?@])?(.*)/.exec(f);a.push({type:1,index:o,name:x[2],strings:p,ctor:x[1]==="."?et:x[1]==="?"?rt:x[1]==="@"?st:S}),s.removeAttribute(l)}else l.startsWith(_)&&(a.push({type:6,index:o}),s.removeAttribute(l));if(Ft.test(s.tagName)){let l=s.textContent.split(_),f=l.length-1;if(f>0){s.textContent=j?j.emptyScript:"";for(let p=0;p<f;p++)s.append(l[p],B()),v.nextNode(),a.push({type:2,index:++o});s.append(l[f],B())}}}else if(s.nodeType===8)if(s.data===Ht)a.push({type:2,index:o});else{let l=-1;for(;(l=s.data.indexOf(_,l+1))!==-1;)a.push({type:7,index:o}),l+=_.length-1}o++}}static createElement(t,e){let r=C.createElement("template");return r.innerHTML=t,r}};function E(i,t,e=i,r){if(t===b)return t;let s=r!==void 0?e._$Co?.[r]:e._$Cl,o=z(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(i),s._$AT(i,e,r)),r!==void 0?(e._$Co??=[])[r]=s:e._$Cl=s),s!==void 0&&(t=E(i,s._$AS(i,t.values),s,r)),t}var tt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:r}=this._$AD,s=(t?.creationScope??C).importNode(e,!0);v.currentNode=s;let o=v.nextNode(),n=0,h=0,a=r[0];for(;a!==void 0;){if(n===a.index){let c;a.type===2?c=new O(o,o.nextSibling,this,t):a.type===1?c=new a.ctor(o,a.name,a.strings,this,t):a.type===6&&(c=new it(o,this,t)),this._$AV.push(c),a=r[++h]}n!==a?.index&&(o=v.nextNode(),n++)}return v.currentNode=C,s}p(t){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}},O=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,r,s){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=E(this,t,e),z(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==b&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):re(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&z(this._$AH)?this._$AA.nextSibling.data=t:this.T(C.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=U.createElement(Bt(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(e);else{let o=new tt(s,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=Pt.get(t.strings);return e===void 0&&Pt.set(t.strings,e=new U(t)),e}k(t){nt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,s=0;for(let o of t)s===e.length?e.push(r=new i(this.O(B()),this.O(B()),this,this.options)):r=e[s],r._$AI(o),s++;s<e.length&&(this._$AR(r&&r._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let r=bt(t).nextSibling;bt(t).remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},S=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,s,o){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=u}_$AI(t,e=this,r,s){let o=this.strings,n=!1;if(o===void 0)t=E(this,t,e,0),n=!z(t)||t!==this._$AH&&t!==b,n&&(this._$AH=t);else{let h=t,a,c;for(t=o[0],a=0;a<o.length-1;a++)c=E(this,h[r+a],e,a),c===b&&(c=this._$AH[a]),n||=!z(c)||c!==this._$AH[a],c===u?t=u:t!==u&&(t+=(c??"")+o[a+1]),this._$AH[a]=c}n&&!s&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},et=class extends S{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}},rt=class extends S{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}},st=class extends S{constructor(t,e,r,s,o){super(t,e,r,s,o),this.type=5}_$AI(t,e=this){if((t=E(this,t,e,0)??u)===b)return;let r=this._$AH,s=t===u&&r!==u||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==u&&(r===u||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},it=class{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){E(this,t)}};var ie=ot.litHtmlPolyfillSupport;ie?.(U,O),(ot.litHtmlVersions??=[]).push("3.3.3");var zt=(i,t,e)=>{let r=e?.renderBefore??t,s=r._$litPart$;if(s===void 0){let o=e?.renderBefore??null;r._$litPart$=s=new O(t.insertBefore(B(),o),o,void 0,e??{})}return s._$AI(i),s};var ht=globalThis,w=class extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=zt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}};w._$litElement$=!0,w.finalized=!0,ht.litElementHydrateSupport?.({LitElement:w});var oe=ht.litElementPolyfillSupport;oe?.({LitElement:w});(ht.litElementVersions??=[]).push("4.2.2");var Ut=i=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(i,t)}):customElements.define(i,t)};var k="ha-fridge-card",ne=new Set(["unknown","unavailable","none"]),ae=192,he=387,le=["default","freezer","inverted","french_door","dual_door"];function ce(i){switch(i){case"freezer":return{freezer:{x:12,y:12,width:168,height:363}};case"default":return{freezer:{x:12,y:12,width:168,height:Math.round(363*.3)},fridge:{x:12,y:12+Math.round(363*.3)+2,width:168,height:Math.round(363*(1-.3))-2}};case"inverted":case"french_door":return{fridge:{x:12,y:12,width:168,height:Math.round(363*(1-.3))-2},freezer:{x:12,y:12+Math.round(363*(1-.3)),width:168,height:Math.round(363*.3)}};case"dual_door":return{freezer:{x:12,y:12,width:82,height:363},fridge:{x:98,y:12,width:82,height:363}};default:return{}}}function de(i){switch(i){case"freezer":{let s=12+Math.round(181.5)-26;return $`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
      ...
      </svg>`}case"default":{let o=Math.round(108.89999999999999),n=Math.round(363*(1-.3))-2,h=12+o,a=h+2+Math.round(n/2)-26;return $`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="1.5" />
        ...
        <rect x="12" y="${h}" width="168" height="2" rx="1" fill="#D6DCE4" />
        <rect x="12" y="${h+2}" width="168" height="${n}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="0.8" />
        <rect x="20" y="${h+2+Math.round(n/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        ...
        <rect x="20" y="385" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="385" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}case"inverted":{let o=Math.round(254.1)-2,n=Math.round(363*.3),h=12+o,a=12+Math.round(o/2)-26;return $`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="1.5" />
        <rect x="12" y="${12}" width="168" height="${o}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="0.8" />
        <rect x="20" y="${12+Math.round(o/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        <rect x="76" y="${a}" width="40" height="52" rx="4" fill="#C8CED6" stroke="#B0B8C4" stroke-width="0.8" />
        ...
        <rect x="20" y="385" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="385" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}case"french_door":{let o=Math.round(254.1)-2,n=Math.round(363*.3),h=12+o,a=78,c=12+Math.round(o/2)-26,d=12+Math.round(a/2)-20;return $`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="1.5" />
        ...
        <rect x="20" y="385" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="385" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}case"dual_door":{let h=12+Math.round(41)-20,a=12+Math.round(363/2)-26;return $`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="1.5" />
        <rect x="${12}" y="${12}" width="${82}" height="${363}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="0.8" />
        <rect x="${92}" y="${12+Math.round(363/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        <rect x="${h}" y="${a}" width="40" height="52" rx="4" fill="#C8CED6" stroke="#B0B8C4" stroke-width="0.8" />
        <rect x="${h+4}" y="${a+4}" width="32" height="20" rx="3" fill="#2C2C3A" />
        <rect x="${h+14}" y="${a+28}" width="12" height="14" rx="2" fill="#8A919A" />
        <rect x="${h+10}" y="${a+44}" width="20" height="5" rx="2" fill="#A0A8B4" />
                  ...
                  ${o&&e.fridge?$`
                        <section class="reading zone-fridge"
                          ...
                          <div class=${this.temperatureClass(h)}>
                            ...
                            ${h.unitText?$`<span class="unit">${h.unitText}</span>`:u}
                          </div>
                        </section>
                      `:u}
                </div>
