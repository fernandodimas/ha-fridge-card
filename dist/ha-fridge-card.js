...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Mt=/'/g,kt=/"/g,Ft=/^(?:script|style|textarea|title)$/i,ht=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),f=ht(1),ye=ht(2),xe=ht(3),b=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Pt=new WeakMap,v=C.createTreeWalker(C,129);function Bt(i,t){if(!nt(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Et!==void 0?Et.createHTML(t):t}var se=(i,t)=>{let e=i.length-1,r=[],s,o=t===2?"<svg>":t===3?"<math>":"",n=F;for(let h=0;h<e;h++){let l=i[h],c,d,a=-1,g=0;for(;g<l.length&&(n.lastIndex=g,d=n.exec(l),d!==null);)g=n.lastIndex,n===F?d[1]==="!--"?n=St:d[1]!==void 0?n=Dt:d[2]!==void 0?(Ft.test(d[2])&&(s=RegExp("</"+d[2],"g")),n=A):d[3]!==void 0&&(n=A):n===A?d[0]===">"?(n=s??F,a=-1):d[1]===void 0?a=-2:(a=n.lastIndex-d[2].length,c=d[1],n=d[3]===void 0?A:d[3]==='"'?kt:Mt):n===kt||n===Mt?n=A:n===St||n===Dt?n=F:(n=A,s=void 0);let p=n===A&&i[h+1].startsWith("/>")?" ":"";o+=n===F?l+ee:a>=0?(r.push(c),l.slice(0,a)+Tt+l.slice(a)+_+p):l+_+(a===-2?h:p)}return[Bt(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},U=class i{constructor({strings:t,_$litType$:e},r){let s;this.parts=[];let o=0,n=0,h=t.length-1,l=this.parts,[c,d]=se(t,e);if(this.el=i.createElement(c,r),v.currentNode=this.el.content,e===2||e===3){let a=this.el.content.firstChild;a.replaceWith(...a.childNodes)}for(;(s=v.nextNode())!==null&&l.length<h;){if(s.nodeType===1){if(s.hasAttributes())for(let a of s.getAttributeNames())if(a.endsWith(Tt)){let g=d[n++],p=s.getAttribute(a).split(_),y=/([.?@])?(.*)/.exec(g);l.push({type:1,index:o,name:y[2],strings:p,ctor:y[1]==="."?et:y[1]==="?"?rt:y[1]==="@"?st:S}),s.removeAttribute(a)}else a.startsWith(_)&&(l.push({type:6,index:o}),s.removeAttribute(a));if(Ft.test(s.tagName)){let a=s.textContent.split(_),g=a.length-1;if(g>0){s.textContent=q?q.emptyScript:"";for(let p=0;p<g;p++)s.append(a[p],B()),v.nextNode(),l.push({type:2,index:++o});s.append(a[g],B())}}}else if(s.nodeType===8)if(s.data===zt)l.push({type:2,index:o});else{let a=-1;for(;(a=s.data.indexOf(_,a+1))!==-1;)l.push({type:7,index:o}),a+=_.length-1}o++}}static createElement(t,e){let r=C.createElement("template");return r.innerHTML=t,r}};function E(i,t,e=i,r){if(t===b)return t;let s=r!==void 0?e._$Co?.[r]:e._$Cl,o=H(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(i),s._$AT(i,e,r)),r!==void 0?(e._$Co??=[])[r]=s:e._$Cl=s),s!==void 0&&(t=E(i,s._$AS(i,t.values),s,r)),t}var tt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:r}=this._$AD,s=(t?.creationScope??C).importNode(e,!0);v.currentNode=s;let o=v.nextNode(),n=0,h=0,l=r[0];for(;l!==void 0;){if(n===l.index){let c;l.type===2?c=new O(o,o.nextSibling,this,t):l.type===1?c=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(c=new it(o,this,t)),this._$AV.push(c),l=r[++h]}n!==l?.index&&(o=v.nextNode(),n++)}return v.currentNode=C,s}p(t){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}},O=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,r,s){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=E(this,t,e),H(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==b&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):re(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&H(this._$AH)?this._$AA.nextSibling.data=t:this.T(C.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=U.createElement(Bt(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(e);else{let o=new tt(s,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=Pt.get(t.strings);return e===void 0&&Pt.set(t.strings,e=new U(t)),e}k(t){nt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,s=0;for(let o of t)s===e.length?e.push(r=new i(this.O(B()),this.O(B()),this,this.options)):r=e[s],r._$AI(o),s++;s<e.length&&(this._$AR(r&&r._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let r=bt(t).nextSibling;bt(t).remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},S=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,s,o){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=u}_$AI(t,e=this,r,s){let o=this.strings,n=!1;if(o===void 0)t=E(this,t,e,0),n=!H(t)||t!==this._$AH&&t!==b,n&&(this._$AH=t);else{let h=t,l,c;for(t=o[0],l=0;l<o.length-1;l++)c=E(this,h[r+l],e,l),c===b&&(c=this._$AH[l]),n||=!H(c)||c!==this._$AH[l],c===u?t=u:t!==u&&(t+=(c??"")+o[l+1]),this._$AH[l]=c}n&&!s&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},et=class extends S{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}},rt=class extends S{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}},st=class extends S{constructor(t,e,r,s,o){super(t,e,r,s,o),this.type=5}_$AI(t,e=this){if((t=E(this,t,e,0)??u)===b)return;let r=this._$AH,s=t===u&&r!==u||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==u&&(r===u||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},it=class{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){E(this,t)}};var ie=ot.litHtmlPolyfillSupport;ie?.(U,O),(ot.litHtmlVersions??=[]).push("3.3.3");var Ht=(i,t,e)=>{let r=e?.renderBefore??t,s=r._$litPart$;if(s===void 0){let o=e?.renderBefore??null;r._$litPart$=s=new O(t.insertBefore(B(),o),o,void 0,e??{})}return s._$AI(i),s};var at=globalThis,w=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ht(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}};w._$litElement$=!0,w.finalized=!0,at.litElementHydrateSupport?.({LitElement:w});var oe=at.litElementPolyfillSupport;oe?.({LitElement:w});(at.litElementVersions??=[]).push("4.2.2");var Ut=i=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(i,t)}):customElements.define(i,t)};var M="ha-fridge-card",ne=new Set(["unknown","unavailable","none"]),he=192,ae=387,le=["default","freezer","inverted","french_door","dual_door"];function ce(i,t){let s=t/100;switch(i){case"freezer":return{freezer:{x:16,y:12,width:160,height:365}};case"default":return{freezer:{x:16,y:12,width:160,height:Math.round(365*s)},fridge:{x:16,y:12+Math.round(365*s)+2,width:160,height:Math.round(365*(1-s))-2}};case"inverted":case"french_door":return{fridge:{x:16,y:12,width:160,height:Math.round(365*(1-s))-2},freezer:{x:16,y:12+Math.round(365*(1-s)),width:160,height:Math.round(365*s)}};case"dual_door":{let o=Math.round(160*s);return{freezer:{x:12,y:12,width:o,height:365},fridge:{x:12+o+4,y:12,width:160-o,height:365}}}default:return{}}}function de(i,t,e){let r=t/100,s=365,o=12,n=8;switch(i){case"freezer":{let h=o+Math.round(s/2)-26;return f`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
      ...
      </svg>`}case"default":{let h=Math.round(s*r),l=Math.round(s*(1-r))-2,c=o+h,d=c+2+Math.round(l/2)-26;return f`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="${n}" />
        <rect x="16" y="${o}" width="160" height="${h}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="24" y="${o+Math.round(h/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        <rect x="14" y="${c}" width="164" height="2" rx="1" fill="#D6DCE4" />
        <rect x="16" y="${c+2}" width="160" height="${l}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="24" y="${c+2+Math.round(l/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        ${e?f`
          <rect x="76" y="${d}" width="40" height="52" rx="4" fill="#C8CED6" stroke="#B0B8C4" stroke-width="${n}" />
          <rect x="80" y="${d+4}" width="32" height="20" rx="3" fill="#2C2C3A" />
          <rect x="90" y="${d+28}" width="12" height="14" rx="2" fill="#8A919A" />
          <rect x="86" y="${d+44}" width="20" height="5" rx="2" fill="#A0A8B4" />
        `:u}
        <rect x="20" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}case"inverted":{let h=Math.round(s*(1-r))-2,l=Math.round(s*r),c=o+h,d=o+Math.round(h/2)-26;return f`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="${n}" />
        <rect x="16" y="${o}" width="160" height="${h}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="24" y="${o+Math.round(h/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        ${e?f`
        ...
        <rect x="20" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}case"french_door":{let h=Math.round(s*(1-r))-2,l=Math.round(s*r),c=o+h,d=78,a=o+Math.round(h/2)-26;return f`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="${n}" />
        <rect x="16" y="${o}" width="${d}" height="${h}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="78" y="${o+Math.round(h/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        ${e?f`
          <rect x="35" y="${o+Math.round(h/2)-26}" width="40" height="52" rx="4" fill="#C8CED6" stroke="#B0B8C4" stroke-width="${n}" />
          <rect x="39" y="${o+Math.round(h/2)-22}" width="32" height="20" rx="3" fill="#2C2C3A" />
          <rect x="49" y="${o+Math.round(h/2)+2}" width="12" height="14" rx="2" fill="#8A919A" />
          <rect x="45" y="${o+Math.round(h/2)+18}" width="20" height="5" rx="2" fill="#A0A8B4" />
        `:u}
        <rect x="96" y="${o}" width="2" height="${h}" rx="1" fill="#D6DCE4" />
        <rect x="98" y="${o}" width="${d}" height="${h}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="102" y="${o+Math.round(h/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        <rect x="14" y="${c}" width="164" height="2" rx="1" fill="#D6DCE4" />
        <rect x="16" y="${c+2}" width="160" height="${l}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="76" y="${c+10}" width="36" height="4" rx="2" fill="#B0B8C4" />
        <rect x="20" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}case"dual_door":{let h=Math.round(160*r),l=160-h,c=12+h+4;return f`<svg class="fridge-svg" viewBox="0 0 192 387" preserveAspectRatio="none">
        <rect x="4" y="4" width="184" height="379" rx="12" fill="#ECEFF3" stroke="#C8CED6" stroke-width="${n}" />
        <rect x="12" y="${o}" width="${h}" height="${s}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="${c-4}" y="${o+Math.round(s/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        ${e?f`
          <rect x="${12+Math.round(h/2)-20}" y="${o+40}" width="40" height="52" rx="4" fill="#C8CED6" stroke="#B0B8C4" stroke-width="${n}" />
          <rect x="${12+Math.round(h/2)-16}" y="${o+44}" width="32" height="20" rx="3" fill="#2C2C3A" />
          <rect x="${12+Math.round(h/2)-6}" y="${o+68}" width="12" height="14" rx="2" fill="#8A919A" />
          <rect x="${12+Math.round(h/2)-10}" y="${o+84}" width="20" height="5" rx="2" fill="#A0A8B4" />
        `:u}
        <rect x="${c-2}" y="${o}" width="2" height="${s}" rx="1" fill="#D6DCE4" />
        <rect x="${c}" y="${o}" width="${l}" height="${s}" rx="8" fill="#F5F7FA" stroke="#D6DCE4" stroke-width="${n}" />
        <rect x="${c+4}" y="${o+Math.round(s/2)-18}" width="4" height="36" rx="2" fill="#B0B8C4" />
        <rect x="20" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
        <rect x="162" y="381" width="10" height="6" rx="2" fill="#C8CED6" />
      </svg>`}default:return f``}}var Ot,lt,ue;Ot=[Ut(M)];var D=class extends(ue=w){_config;_hass;static getConfigForm(){return{schema:[{name:"title",selector:{text:{}}},{name:"show_title",selector:{select:{mode:"dropdown",options:[{value:"true",label:"Yes"},{value:"false",label:"No"}]}}},{name:"layout",selector:{select:{mode:"dropdown",options:[{value:"default",label:"Freezer on top"},{value:"inverted",label:"Fridge on top"},{value:"dual_door",label:"Side by side"},{value:"french_door",label:"French door"},{value:"freezer",label:"Freezer only"}]}}},{name:"freezer_entity",selector:{entity:{domain:"sensor"}}},{name:"fridge_entity",selector:{entity:{domain:"sensor"}}},{name:"freezer_label",selector:{text:{}}},{name:"fridge_label",selector:{text:{}}},{name:"show_dispenser",selector:{select:{mode:"dropdown",options:[{value:"true",label:"Yes"},{value:"false",label:"No"}]}}},{name:"split_ratio",selector:{number:{min:20,max:80,step:1,mode:"slider",unit_of_measurement:"%"}}},{name:"card_width",selector:{number:{min:100,max:400,step:10,mode:"slider",unit_of_measurement:"px"}}},{name:"card_height",selector:{number:{min:200,max:600,step:10,mode:"slider",unit_of_measurement:"px"}}}],computeLabel:t=>{switch(t.name){case"title":return"Title";case"show_title":return"Show title";case"layout":return"Layout";case"freezer_entity":return"Freezer sensor";case"fridge_entity":return"Fridge sensor";case"freezer_label":return"Freezer label";case"fridge_label":return"Fridge label";case"show_dispenser":return"Show ice dispenser";case"split_ratio":return"Freezer / Fridge ratio";case"card_width":return"Width";case"card_height":return"Height";default:return}}}}getStubConfig(){return{type:`custom:${M}`,freezer_entity:"sensor.freezer_temperature",fridge_entity:"sensor.fridge_temperature",title:"Fridge",layout:"default",show_dispenser:!0}}setConfig(t){let e=this.normalizeLayout(t.layout);this._config={title:"Fridge",...t,layout:e}}set hass(t){this._hass=t,this.requestUpdate()}get hass(){return this._hass}getCardSize(){return 3}render(){if(!this._config)return u;let t=this.normalizeLayout(this._config.layout),e=this._config.split_ratio??30,r=ce(t,e),s=this._config.show_title!=="false"&&this._config.show_title!==!1,o=this._config.show_dispenser!=="false"&&this._config.show_dispenser!==!1,n=!0,h=!!r.fridge,l=this.getDisplayState(this._config.freezer_entity),c=h?this.getDisplayState(this._config.fridge_entity):null,d=this.cardLabel(n,h),a=this._config.freezer_label||"Freezer",g=this._config.fridge_label||"Fridge",p=this._config.card_width||230,y=this._config.card_height||387;return f`
      <ha-card>
                  ...
                  ${n&&r.freezer?f`
                        <section class="reading zone-freezer"
                          ...
                          <div class=${this.temperatureClass(l)}>
                            ...
                            ${l.unitText?f`<span class="unit">${l.unitText}</span>`:u}
                          </div>
                        </section>
                      `:u}
                  ${h&&r.fridge?f`
                        <section class="reading zone-fridge"
                          ...
                          <div class=${this.temperatureClass(c)}>
                            ...
                            ${c.unitText?f`<span class="unit">${c.unitText}</span>`:u}
                          </div>
                        </section>
                      `:u}
                </div>
